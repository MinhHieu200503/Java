...
public class MotobikeGUI extends javax.swing.JPanel implements ActionListener {
    ...
    private void initComponents() {
        ...
        Header.add(panelMotobikeID, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 60, -1, 40));
        ...
        Header.add(panelCountryOfmanufacture, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 100, 410, 40));
        ...
        Header.add(panelRangeOfVehicle, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 140, 410, 40));
        ...
        Header.add(panelCubic, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 180, 410, 40));
        ...
        panelTheFrameOfTheMachine.add(txtTheFrameOfTheMachine, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 0, 270, 30));
        ...
        Header.add(panelTheFrameOfTheMachine, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 60, 460, 40));
        ...
        panelNumberOfRibs.add(txtNumberOfRibs, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 0, 270, 30));
        ...
        Header.add(panelNumberOfRibs, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 100, 460, 40));
        ...
        Header.add(panelColor, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 140, 460, 40));
        ...
        Header.add(panelWarrantyPeriod, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 180, 460, 40));
        ...
        model = new DefaultTableModel(new String[] {"Mã Xe", "Nước Sản Xuất", "Loại Xe", "Số Phân Khúc", "Số Khung", "Số Sườn", "Màu Xe", "Thời Gian Bảo Hành"},0){
            @Override
