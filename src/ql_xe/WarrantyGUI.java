...
public class WarrantyGUI extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        Header.add(panelWarranty, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 60, 480, 40));
        ...
        Header.add(panelContract, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 100, 480, 40));
        ...
        Header.add(panelMotobikeID, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 140, 480, 40));
        ...
        Header.add(panelWarrantyDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 180, 480, 40));
        ...
        model = new DefaultTableModel(new String[] {"Mã Bảo Hành", "Mã Hóa Đơn", "Mã Xe", "Ngày Bảo Hành", "Tên Linh Kiện", "Lỗi", "Giá Tiền"},0){
            @Override
